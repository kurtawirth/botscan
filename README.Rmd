...
There is only one function currently live for botscan. The sole argument takes
any Twitter query and produces the percentage of the conversation's authors
that are at least 90% likely to be a bot.
